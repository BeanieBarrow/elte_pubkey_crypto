...
\subsection{Secure multiparty computations (MPC)}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item The Group Manager $M$ can resolve $\sigma$ (i.e. can learn the actual signer $S_i$)
	\end{itemize}
	\item Algorithms:
	\begin{itemize}
...
\subsubsection{Example of group signature protocols}
...
\subsection{Proof of knowledge protocols}

\subsubsection{Schnorr's PoK protocol}
...
\subsubsection{Non-interactive PoK protocol}
