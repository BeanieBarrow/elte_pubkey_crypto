...
\begin{remark}\leavevmode
	\begin{itemize}
		\item A similar addition law can be given, but we do not have to distinguish $P = \infty, P \ne \infty$.
...
As $E \stackrel{\sim}{=} \mathbb{Z}_N$ or $\mathbb{Z}_N \times \mathbb{Z}_M$, $E$ and $P$ can be chosen such that $l \approx P$.
...
\begin{itemize}
	\item $\Gen$:
	\begin{itemize}
		\item Let $p$ be a prime and $E$ be an elliptic curve over $\mathbb{Z}_P, P \in E$ of order $l$.
